---
title: "Confusion Matrix - training materials" # See below for multilingual resource
include-before-body:
...
description: 
    This training material was prepared using the AIML4OS template. 
    It demonstrates how to work with a confusion matrix in `Python`, 
    applying the `scikit-learn` library and the `Iris` dataset..
...
It presents the concept of the confusion matrix in {{< fa brands python >}},  
